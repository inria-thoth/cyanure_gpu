...
The last dataset is generated by encoding the `MNIST <http://yann.lecun.com/exdb/mnist/>`_  dataset with a two-layer `convolutional kernel network (CKN), NIPS'16 <https://hal.inria.fr/hal-01387399/document>`_.
...
+------------+------------+--------------+-------------+-----------+--------------+
| imnet      | No         | 1            | 250000      | 2000      | 9.8            |
+------------+------------+--------------+-------------+-----------+--------------+
| places     | No         | 1            | 2500000     | 1155      | 19         |
+------------+------------+--------------+-------------+-----------+--------------+
| inat       | No         | 10           | 60000       |   2304    | 3.3        |
+------------+------------+--------------+-------------+-----------+--------------+
...
optimal :math:`\lambda`: covtype, epsilon, ckn_mnist, svhn -- the hard ones
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
