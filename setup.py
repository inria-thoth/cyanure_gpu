...
setup(name='cyanure_pytorch',
      ...
      install_requires=["scipy<=1.8.1;python_version<'3.11'", "scipy>=1.8.1;python_version>='3.11'", "numpy>=1.26.0;python_version>='3.11'", "numpy<=1.23.5;python_version<'3.11'",'scikit-learn', 'torch<2.3.0'],
